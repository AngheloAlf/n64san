...
// Bold
#define VT_BOLD_VAL "1"

// Bold color support
#define VT_BOLD() VT_SGR(VT_BOLD_VAL)
#define VT_BOLD_FGCOL(color) VT_SGR(VT_BOLD_VAL ";" VT_COLOR(FOREGROUND, color))
#define VT_BOLD_BGCOL(color) VT_SGR(VT_BOLD_VAL ";" VT_COLOR(BACKGROUND, color))
